...
\begin{frame}{Next steps}
	\begin{itemize}
		...
		\item \textbf{Cycad aulacaspis scale.} Implement an effective island-wide biocontrol program which will allow natural reproduction of surviving cycads (as per recommendations by Dr. Ronald Cave)
		\item \textbf{Coconut rhinoceros beetle.} Find and release an effective self-sustaining biological control agent for CRB-G which will suppress populations, reduce damage and halt palm mortality.
